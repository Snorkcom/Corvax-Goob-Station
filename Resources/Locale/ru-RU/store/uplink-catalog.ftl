...
uplink-emag-desc = Он же ЕМАГ, визитная карточка Синдиката. Устройство, способное взламывать различные станционные устройства и разблокировать чужие аплинки без кода. Перезаряжается автоматически.
